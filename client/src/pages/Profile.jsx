  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form className="flex flex-col gap-4">
        ...
        <img src={currentUser.profilePicture} alt="profile" onClick={()=>fileRef.current.click()} className="h-24 w-24 rounded-full self-center cursor-pointer object-cover mt-2"/>
